          ...
          <td>
              <table class="uno">
                  <tr>
                    ...
                    <td class="tdlibro"> Fecha Expansion </td>
                    <td> <a href="Expansion (Admin).jsp"><button name="foro" class="boton_user">Ver Expansion</button></a><td>
                  </tr>
                </table>
          </td>
        </tr>
