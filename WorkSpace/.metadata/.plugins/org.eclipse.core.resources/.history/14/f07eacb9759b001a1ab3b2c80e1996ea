...
<%
	...
	int id = 0;
		...
		if(Usuario.registrarse(1, 1, request.getParameter("nombre"), request.getParameter("apellidos"), request.getParameter("usuario"), request.getParameter("password"),request.getParameter("email") , request.getParameter("carnet")) == true){
