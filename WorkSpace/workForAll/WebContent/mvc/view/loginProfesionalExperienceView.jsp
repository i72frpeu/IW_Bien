...
<meta charset="ISO-8859-1">
  <title>Login Profesional Experience</title>
  ...
  <div>
     <table class="table_curr">
         <tr>
             ...
             <td>
                 <form action="../control/insertProfesionalControl.jsp" method="post">
                    <input type="text" name="Tipo" id="tipo" placeholder="Tipo" required><br>
                    <input type="text" name="Empresa" id="empresa" placeholder="Empresa" required><br>
                    ...
                    <select name="dia2" id="dia2" class = "dia">
                        ...
                        <input type="text" name="year2" id="year2" placeholder="Año" required><br>
