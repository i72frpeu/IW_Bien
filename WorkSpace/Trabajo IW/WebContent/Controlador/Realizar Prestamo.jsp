...
<%
 PrestamoDAO nuevoPrestamo = new PrestamoDAO();
	...
	nuevoPrestamo.anadirPrestamos(id, request.getParameter("libro"), request.getParameter("Autor"), request.getParameter("usuario"), request.getParameter("carnet"), Integer.parseInt(request.getParameter("fecha")));
		
	nuevoPrestamo.setId_prestamo(id);
	nuevoPrestamo.setTitulo(request.getParameter("libro"));
	...
	if(nuevoPrestamo.getTitulo().equals(libro)){
		prestamoactivo.setTitulo(request.getParameter("libro"));
