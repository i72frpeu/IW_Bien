...
<body>
  ...
  <div class="div_home">
		...
		<tr>
			<td class = "tdlibro" rowspan = 4> Imagen </td> <td class = "tdlibro"> ID: <%= prestamoactivo.getId_prestamo() %> </td> <td class = "tdlibro" colspan = 2> Titulo: <%= prestamoactivo.getTitulo() %> </td>
		</tr>
		<tr>
			<td class = "tdlibro" colspan = 2> Usuario: <%= prestamoactivo.getUsuario() %> </td> <td class = "tdlibro"> Carnet: <%= prestamoactivo.getCarnet() %> </td>
		</tr>
		<tr>
			<td class = "tdlibro"> Fecha Inicio: <%= prestamoactivo.getFecha_inicio_prestamo() %> </td> <td class = "tdlibro"> Fecha Final: <%= prestamoactivo.getFecha_final_prestamo() %> </td> <td class = "tdlibro"> Retraso: Si o No </td>
		</tr>
		<tr>
