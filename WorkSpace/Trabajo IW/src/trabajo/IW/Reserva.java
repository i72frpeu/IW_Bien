...
public class Reserva{
  ...
  public Reserva(int idReserva, String titulo, String usuario, String carnet_universidad, int fecha_inicio_Reserva){
		super();
...
public static void crearReserva(int idReserva, String titulo, String usuario, String carnet_universidad, int fecha_inicio_Reserva) throws FileNotFoundException{
    try{
      if(comprobarId(idReserva)) {
                System.out.println("El libro a reservar no esta disponible en este momento");
            }else {
                Reserva aux = new Reserva(idReserva, titulo, usuario, carnet_universidad, fecha_inicio_Reserva);
                Writer output = new BufferedWriter(new FileWriter("C:/User/reservas.csv",true));
                output.append("\n" + String.valueOf(idReserva) + "," + titulo + "," + usuario + "," + carnet_universidad + "," + String.valueOf(fecha_inicio_Reserva) + "," + String.valueOf(fecha_inicio_Reserva+30));
...
public static void guardarReserva(int id) throws FileNotFoundException{
    //
	//
	//
  }
